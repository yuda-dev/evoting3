                ...
                <div class="card card-primary card-outline">
                   <div class="card-body box-profile">
                     ...
                     <div class="row">
                         ...
                         <div class="col-6">
                           <a href="{{ url('simpan_suara', $kdt->id) }}" class="btn btn-success btn-block" style="width:100%" onclick="return confirm('Yakin memilih {{ $kdt->nama}} ?');"><b></b><i class="fa fa-edit"> Pilih</i> </a>
                         </div>
                     </div>
                   </div>
                   <!-- /.card-body -->
